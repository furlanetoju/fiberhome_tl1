...
```
**Alterar o profile de velocidade**
```
CFG-ONUBWPROFILE::OLTID=10.111.11.2,PONID=NA-NA-15-12,ONUIDTYPE=MAC,ONUID=FHTT073cff10:CTAG::BW=500M;
```

**Lista as vlans configuradas na ONU**
```
LST-PORTVLAN::OLTID=10.111.11.2,PONID=NA-NA-15-12,ONUIDTYPE=MAC,ONUID=FHTT091bfd80,ONUPORT=NA-NA-NA-1:CTAG::;
```

**Deleta as vlans configuradas na ONU:**
```
DEL-LANPORTVLAN::OLTID=10.111.11.2,PONID=NA-NA-15-12,ONUIDTYPE=MAC,ONUID=FHTT091bfd80,ONUPORT=NA-NA-NA-1:CTAG::;
```

**Configurando a VLAN na lan da ONU Bridge:**
```
CFG-LANPORTVLAN::OLTID=10.111.11.2,PONID=NA-NA-15-12,ONUIDTYPE=MAC,ONUID=FHTT091bfd80,ONUPORT=NA-NA-NA-1:CTAG::CVLAN=999,CCOS=0;
```

**Listar toda configuração da WAN da ONT:**
```
LST-ONUWANSERVICECFG::OLTID=10.111.11.2,PONID=NA-NA-15-12,ONUIDTYPE=MAC,ONUID=FHTTFE26E7D0:CTAG::;
```

**Para remover a linha da wan:**
```
SET-WANSERVICE::OLTID=10.111.11.2,PONID=NA-NA-15-12,ONUIDTYPE=MAC,ONUID=FHTTFE26E7D0:CTAG::STATUS=2;
```
